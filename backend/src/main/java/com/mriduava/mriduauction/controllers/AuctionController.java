package com.mriduava.mriduauction.controllers;

import com.mriduava.mriduauction.entities.AuctionItem;
import com.mriduava.mriduauction.services.AuctionService;
...
public class AuctionController {
    ...
    public List<AuctionItem> getByItemName(@PathVariable String name) {
        ...
        return auctionService.getByItemName(itemName);
    }
